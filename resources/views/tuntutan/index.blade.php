                                ...
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            <th scope="col" class="sort" data-sort="name">No</th>
                                            <th scope="col" class="sort" data-sort="budget">Tarikh Mohon</th>
                                            <th scope="col" class="sort" data-sort="status">Kerani bertugas</th>
                                            <th scope="col" class="sort" data-sort="budget">tuntutan kakitangan</th>
                                            <th scope="col" class="sort" data-sort="status">Sebab kemaskini</th>
                                            <th scope="col" class="sort" data-sort="status">Pegawai Sokong </th>
                                            <th scope="col" class="sort" data-sort="status">Pegawai Lulus </th>
                                        </tr>
                                    </thead>
                                    <tbody class="list">
                                    </tbody>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <!-- Card header -->
                            <div class="card-header border-0">
                                <h3 class="mb-0">Modul ini tidak dapat dijalankan pada peranan anda. Sila hubungi pentadbir sistem anda.</h3>
                            </div>
                        </div>
                    </div>
                </div>
