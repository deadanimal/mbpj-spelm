...
<div class="container-fluid mt--6">
    ...
    <div class="row ">
        ...
        <a  type="button" class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#PastiTuntutan"href="/bulktuntutan" >Hantar Tuntutan</a>
        </div>
        <div class="col-md-12">
                ...
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="overflow-x:scroll; width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input  type="text" id="sebenar_mula_kerja_tuntutan" name="sebenar_mula_kerja_tuntutan" value="{{$tuntutan_k->sebenar_mula_kerja}}" disabled><br><br>
                            ...
                            <td >
                                <input class="text-center" type="text" style="width:60px;"  onchange="KemaskiniJamTuntutan({{$tuntutan_k->id}}, this)" value="{{$tuntutan_k->jam_kerja_biasa_siang}}" disabled>
                                <input class="text-center" type="text" style="width:60px;"  onchange="KemaskiniJamTuntutan({{$tuntutan_k->id}}, this)" value="{{$tuntutan_k->jam_kerja_biasa_malam}}" disabled>

                            </td>
                            <td >
                                <input class="text-center" type="text" style="width:60px;"  onchange="KemaskiniTotalTuntutan({{$tuntutan_k->id}}, this)" value="{{$tuntutan_k->jam_kerja_cuti_siang}}"disabled>
                                <input class="text-center" type="text" style="width:60px;"  onchange="KemaskiniTotalTuntutan({{$tuntutan_k->id}}, this)"value= "{{$tuntutan_k->jam_kerja_cuti_malam}}" disabled>

                            </td>
                            <td >
                                <input class="text-center" type="text" style="width:60px;" onchange="KemaskiniStatus2({{$tuntutan_k->id}}, this)"value="{{$tuntutan_k->jam_kerja_am_siang}}" disabled>
                                <input class="text-center" type="text" style="width:60px;" onchange="KemaskiniStatus2({{$tuntutan_k->id}}, this)"value="{{$tuntutan_k->jam_kerja_am_malam}} "disabled>
                    ...
                    <div class="modal fade" id="PastiTuntutan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Tutup</button>
                                <a href="/bulktuntutan" class="btn btn-primary btn-sm float-right">Hantar Tuntutan</a>
                            </div>
                        </div>
                        </div>
                    </div>
                                ...
                                @elseif($tuntutan_lulus->sokong_tuntutan === 1)
                                    ...
                                    <td>
                                        ...
                                        @if($tuntutan_lulus->periksa_tuntutan === null)
                                            ...
                                            <span class="badge badge-pill badge-primary">Dalam Semakan</span> : KERANI PEMERIKSA<br><br>

                                            @if($tuntutan_lulus->semak_tuntutan === null)

                                            <span class="badge badge-pill badge-primary">Dalam Semakan</span> : KERANI SEMAKAN<br><br>
        
                                             @elseif($tuntutan_lulus->semak_tuntutan === 1)
    
                                            <span class="badge badge-pill badge-success">Tuntutan Diluluskan</span> : KERANI SEMAKAN <br><br>
                                            
                                             @endif 
        
                                        @elseif($tuntutan_lulus->periksa_tuntutan === 1)

                                            <span class="badge badge-pill badge-success">Tuntutan Diperiksa</span> : KERANI PEMERIKSA <br><br>
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>            
                                            ...
                                            @if($sokong_tuntutan->sokong_tuntutan === null)
                                                ...
                                                <td>
                                                    <a href="/tuntutans/{{$sokong_tuntutan->id}}/"
                                                        class="btn btn-primary btn-sm"><i class="ni ni-zoom-split-in"></i></a>
                                                    <a href="/sokong_tuntutan/{{$sokong_tuntutan->id}}/"
                                        ...
                                        <div class="modal fade" id="tolaksokongtuntutan{{ $sokong_tuntutan->id }}"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-primary">
                                                        <h5 class="modal-title text-white" id="exampleModalLabel">Tolak Tuntutan
                                                            Kakitangan</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                                    ...
                                                                    <div >
                                                                        ...
                                                                        <div class="input-group input-group-merge">
                                                                            <textarea cols="50" rows="4"
                                                                                name="sokong_tuntutan_sebab"
                                                                                placeholder="Sebab" type="text"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="overflow-x:scroll; width:100%">
                                ...
                                <div class="modal fade" id="PastiTuntutan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Tutup</button>
                                            <a href="/bulktuntutan" class="btn btn-primary float-right btn-sm">Hantar Tuntutan</a>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>      
                                            ...
                                            @elseif($periksa_tuntutan->periksa_tuntutan === 1)
                                                    ...
                                                    @elseif($periksa_tuntutan->periksa_tuntutan === 1)
                                                    <td>
                                                        <span class="badge badge-pill badge-success">Tuntutan Diperiksa</span><br><br>
                                                        ...
                                                        <span class="badge badge-pill badge-success">Lulus Semakan</span>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-header border-0">
                                 ...
                                 <!-- Light table -->
                                 <table id="tablekeranisemak" class="display table table-striped table-bordered dt-responsive nowrap" style="overflow-x:scroll; width:100%">
                                    <thead class="thead-light">
                                        ...
                                        <tr>   
                                            ...
                                            @if($semak_tuntutan->semak_tuntutan === null)
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge badge-pill badge-danger"> Semakan Pemeriksa</span>
                ...
                <table id="example" class="display table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                    ...
                    <tbody >
                        ...
                        <tr>
                            ...
                            <th>{{$tuntutan_kemaskini->kerani_periksa_name}}<br><br>  {{$tuntutan_kemaskini->kerani_semak_name}}</th>
                            <th>Sebab : {{$tuntutan_kemaskini->mohon_kemaskini1_sebab}}<br><br> Sebab : {{$tuntutan_kemaskini->mohon_kemaskini2_sebab}}</th>
