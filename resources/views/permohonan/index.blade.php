                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="/permohonans/{{ $permohonan->id }}">Lihat
                                                                lanjut</a>
                                                            <a class="dropdown-item"
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-5">
                                        <div class="form-group">
                                            ...
                                            <select id="selectJenisPermohonan" class="form-select form-select-sm col-8"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nama" id="nama-semakan"
                                ...
                                <div class="row">
                                    <div class="col-5">
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-name">No
                                                    Pekerja</label>
                                                <input type="text" name="noPekerja" id="noPekerja"
                                                    class="form-control form-control-sm" value="" required autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-7">
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-email">No. KP
                                                        Baru</label>
                                                    <input type="text" name="noKPbaru" id="noKPBaru-semakan"
                                                        class="form-control form-control-sm" value="" disabled>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="jawatan" id="jawatan-semakan"
                                                        class="form-control form-control-sm" value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5">
                                        <div class="form-row justify-content-end align-items-end">
                                            <div class="col">
                                                ...
                                                <input id="min" class="form-control form-control-sm"
                                                    placeholder="DD-MM-YYYY" autocomplete="off">
                                            </div>
                                            <div class="col">
                                                <label class="form-control-label" for="max">Ke</label>
                                                <input id="max" class="form-control form-control-sm"
                                                    placeholder="DD-MM-YYYY" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="bahagian" id="bahagian-semakan"
                                                        class="form-control form-control-sm" value="" disabled>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="jabatan" id="jabatan-semakan"
                                                        class="form-control form-control-sm" value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row justify-content-end align-items-end">
                                    <div class="col-md-auto">
                                        <button type="button" onclick="event.preventDefault();" id="padamCarian"
                                            class="btn btn-sm btn-danger">Padam Carian</button>
                                    </div>
                                    <div class="col-md-auto">
                                        <button type="button" onclick="checkUser()" id="semakPenyelia"
                                            class="btn btn-sm btn-success mt-4">Semak</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th scope="col" class="sort" data-sort="budget">clockintime</th>
                                            <th scope="col" class="sort" data-sort="status">clockouttime</th>
                                            <th scope="col" class="sort" data-sort="budget">totalworkinghour
                                            </th>
                                            <th scope="col" class="sort" data-sort="budget">otstarttime1</th>
                                            <th scope="col" class="sort" data-sort="status">otendtime1</th>
                                            <th scope="col" class="sort" data-sort="status">otdurationt1</th>
                        ...
                        <div class="card">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-7">
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-email">No.
                                                        KP
                                                        Baru</label>
                                                    <input type="text" name="noKPbaru" id="noKPBaru-semakan"
                                                        class="form-control form-control-sm" value="" disabled>
                                ...
                                <div class="row justify-content-end align-items-end">
                                    <div class="col-md-auto">
                                        <button type="button" onclick="event.preventDefault();" id="padamCarian"
                                            class="btn btn-sm btn-danger">Padam
                                            Carian</button>
                                    </div>
                                    <div class="col-md-auto">
                                        <button type="button" onclick="checkUser()" id="semakPenyelia"
                                ...
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <!-- eKedatangan -->
                                            <th scope="col" class="sort" data-sort="budget">clockintime</th>
                                            <th scope="col" class="sort" data-sort="status">clockouttime
                                            </th>
                                            <th scope="col" class="sort" data-sort="budget">totalworkinghour
                                            </th>
                                            <th scope="col" class="sort" data-sort="budget">otstarttime1
                                            </th>
                                            <th scope="col" class="sort" data-sort="status">otendtime1</th>
                                            <th scope="col" class="sort" data-sort="status">otdurationt1
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="list">
