            ...
            <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link mb-sm-3 mb-md-0" id="penyeliasokongkakitangan-tab" data-toggle="tab"
                        href="#penyeliasokongkakitangan" role="tab" aria-controls="penyeliasokongkakitangan" aria-selected="false"><i
                            class="ni ni-calendar-grid-58 mr-2"></i>Semak Permohonan Kerja
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="table-responsive py-4">
                    ...
                    <table id="permohonankakitangan" class="display table table-striped table-bordered dt-responsive nowrap"
                        style="width:100%">
    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="table-responsive py-4">
                    <table id="pengesahankakitangan" class="display table table-striped table-bordered dt-responsive nowrap"
                        style="width:100%">
                        <thead class="thead-light">
                            <tr>
                                <th>No</th>
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td >  
                                    <h5>  Tarikh  : <span style ="color:rgb(255, 0, 21)">{{$permohonan->tarikh}}</span> </h5>
                                    <h5>  Mula   : <span style ="color:rgb(255, 0, 21)"> {{$permohonan->clockintime}}</span> </h5>
                                    <h5>  Akhir  : <span style ="color:rgb(255, 0, 21)">{{$permohonan->clockouttime}}</span> </h5>
                                    {{-- <h5>  Jumlah OT  : <span style ="color:rgb(255, 0, 21)">{{$permohonan->totalworkinghour}}</span> </h5> --}}
                                    <h5>  Status  : <span style ="color:rgb(255, 0, 21)">{{$permohonan->statusdesc}}</span> </h5>
                                    {{-- <h5>  Jumlah Jam  : <span style ="color:rgb(255, 0, 21)">{{$permohonan->totalotduration}}</span> </h5> --}}
                                    <h5>  Waktu Anjal  : <span style ="color:rgb(255, 0, 21)">{{$permohonan->waktuanjal}}</span> </h5>
                                ...
                                <td >
                                    ...
                                    <form method="POST" action="/kemaskinipegawaipengesah/{{$permohonan->id}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="p_pegawai_sokong_id" class="form-control" style="width:100px ; height:35px;">
                                                <option  value="{{$permohonan->p_pegawai_sokong_id}}">{{$permohonan->p_pegawai_sokong_id}}</option>
    
                                                @foreach ($userspengesahan as $userspengesahan1)
                                                <option value="{{$userspengesahan1->id}} ">
                                                    {{$userspengesahan1->name}} - {{$userspengesahan1->role}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">

                                            <select name="p_pegawai_lulus_id" class="form-control"  style="width:100px ; height:35px;">
                                                <option value="{{$permohonan->p_pegawai_lulus_id}}" >{{$permohonan->p_pegawai_lulus_id}}</option>
                                                @foreach ($userspengesahan as $userspengesahan2)
                                                <option value="{{$userspengesahan2->id}}">
                                                    {{$userspengesahan2->name}} - {{$userspengesahan2->role}} </option>
                                                @endforeach
                                            </select>
                                        </div>
...
<div class="tab-content" id="myTabContent">
                                                ...
                                                @elseif($permohonan->sokong_selepas=== null)
                                                    ...
                                                    @if($permohonan->sebenar_akhir_kerja == null)
                                                        ...
                                                        <td class="kemaskini">
                                                                ...
                                                                <a href="/sebenar_mula_akhir_kerja/{{ $permohonan->id }}/"
                                                                    class="btn btn-success btn-sm"><i class="ni ni-send"></i></a>
                                                            <button onclick="buangpermohonan({{ $permohonan->id }})"
                                                                class="btn btn-danger btn-sm"><i class="ni ni-basket"></i></button>
                                                        </td>
    ...
    <div class="tab-pane fade" id="penyeliasokongkakitangan" role="tabpanel" aria-labelledby="penyeliasokongkakitangan-tab">
        <div>
            <div class="container-fluid mt--6"> 
                {{-- <div class="row">
                    <div class="col-xl-3 col-md-6">
                ...
                <div class="row">
                    ...
                    <button  class="btn btn-primary btn-sm " data-url="{{ url('PermohonanSokongAll') }}">Sokong Pilihan</button>
                    <button  class="btn btn-danger btn-sm " data-url="{{ url('PermohonanTolakSokongAll') }}">Tolak Pilihan</button>
                    </div>
                    <div class="col-md-12">
                        <div class="card">
                            <!-- Card header -->
                                        ...
                                        <tr>
                                            ...
                                            <td class="tindakan">
                                                ...
                                                <a href="/sokong_sebelum/{{ $permohonan->id }}/"
                                                    class="btn btn-success btn-sm"><i class="ni ni-like-2"></i></a>
                                            </td>

                                            @elseif($permohonan->sokong_sebelum === 1)
                                            <td>
                                                <span class="badge badge-pill badge-success">Lulus Permohonan PG1</span><br><br>
                ...
                <div class="row ">
                    <div class="col-md-12 mb-3">
                        <button  class="btn btn-primary btn-sm " data-url="{{ url('PermohonanLulusAll') }}">Lulus Pilihan</button>
                        <button  class="btn btn-danger btn-sm " data-url="{{ url('PermohonanTolakLulusAll') }}">Tolak Pilihan</button>
                    </div>
                    <div class="col-md-12">
                        <div class="card">
                            <!-- Card header -->
                                ...
                                <table id="example"
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            @if($permohonan->sokong_sebelum === null)
                                            <td>
                                                <span class="badge badge-pill badge-primary">Semakan Pegawai Sokong</span><br><br>
                                         
                                                <span class="badge badge-pill badge-primary">Semakan Pegawai Lulus</span>
                                            </td>
                                            <td>
                                                --
                                            </td>
    ...
    <div class="tab-pane fade" id="tabs-icons-text-3" role="tabpanel" aria-labelledby="tabs-icons-text-3-tab">
        <div>
            <div class="container-fluid mt--6">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <button  class="btn btn-primary btn-sm " data-url="{{ url('PengesahanSokongAll') }}">Sokong Pilihan</button>
                        <button  class="btn btn-danger btn-sm " data-url="{{ url('PengesahanTolakSokongAll') }}">Tolak Pilihan</button>
                    </div>
                    <div class="col-md-12">
                        <div class="card">
                            <!-- Card header -->
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            @if($permohonan->sebenar_mula_kerja != null)
                                                ...
                                                @elseif($permohonan->sokong_selepas === 0)
                                                    <td >
                                                        <span class="badge badge-pill badge-danger">Ditolak Pegawai </span><br><br>
                                                        {{$permohonan->sokong_selepas_sebab}}
                                                ...
                                                @elseif($permohonan->sokong_selepas === 1)
                                                    <td >
                                                        <span class="badge badge-pill badge-success">Lulus Pegawai </span><br><br>
                                                     
                                                   
                                                        @if($permohonan->lulus_selepas === 1)
                                                        <span class="badge badge-pill badge-success">Lulus Pegawai </span>
                                                        @elseif($permohonan->lulus_selepas === 0)
                                            ...
                                            <td>
                                                <span class="badge badge-pill badge-primary"> Semakan Kakitangan</span>
                                            </td>
                                            <td>
                                                <span class="badge badge-pill badge-primary"> Semakan Kakitangan</span>
                                            </td>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <button  class="btn btn-primary btn-sm " data-url="{{ url('PengesahanLulusAll') }}">Lulus Pilihan</button>
                        <button  class="btn btn-danger btn-sm " data-url="{{ url('PengesahanTolakLulusAll') }}">Tolak Pilihan</button>
                    </div>
                    <div class="col-md-12">
                        <div class="card">
                            <!-- Card header -->
                            ...
                            <div class="table-responsive py-4">
                                <table id="example" class="display table table-striped table-bordered dt-responsive nowrap"
                                    ...
                                    <thead class="thead-light">
                                        ...
                                        <tr><th> <input type="checkbox" id="LulusPengesahan"/></th>
                                            <th>No</th>
                                            <th>Nama Pemohon<br><br>Mula Kerja lulus <br><br>Akhir Kerja lulus</th>
                                            <th>Ekedatangan Mula Kerja</th>
                                            <th>Waktu Mula Sebenar<br><br>Waktu Akhir Sebenar</th>
                                            <th style="background-color:#00FF00">Pegawai Sokong<br><br>Pegawai Lulus</th>
                                            <th>Status</th>
                                            <th>Tindakan</th>
                                        </tr>
                                    </thead>
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($permohonan->sokong_selepas === 1)
                                                    <td>
                                                          <span class="badge badge-pill badge-success">Lulus Pegawai Sokong</span><br><br>
                                                    ...
                                                    <span class="badge badge-pill badge-success">Lulus Pegawai Lulus</span>
                                                    </td>
                                                    <td>
                                                        --
                                                    </td>
                                                ...
                                                @elseif($permohonan->sokong_selepas === null)
                                                <td>
                                                    <span class="badge badge-pill badge-primary">Dalam Semakan Pegawai Sokong</span><br><br>
                                ...
                                <table id="example"
                                    ...
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th>Waktu Mula<br><br>Waktu Akhir</th>
                                            <th>Lokasi<br><br>Tujuan</th>
                                            <th>Pegawai Sokong <br><br>Pegawai Lulus</th>                                            <th>Status</th>
                                            <th>Tindakan</th>
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            @if($permohonan->sebenar_mula_kerja != null)
                                                ...
                                                <td >
                                                    <span class="badge badge-pill badge-danger">Ditolak Pengesahan </span><br><br>
                                                    {{$permohonan->sokong_selepas_sebab}}
                                                ...
                                                @elseif($permohonan->sokong_selepas === 1)
                                                <td>
                                                    <span class="badge badge-pill badge-success">Lulus Pengesahan </span><br><br>
                                             
                                                    @if($permohonan->lulus_selepas === 1)
                                                    <span class="badge badge-pill badge-success">Lulus Pengesahan </span><br>
                                                    @elseif($permohonan->lulus_selepas === 0)
                                                    <span class="badge badge-pill badge-danger">Ditolak Pengesahan </span><br>
                                                    {{$permohonan->lulus_selepas_sebab}}
                                                    @elseif($permohonan->lulus_selepas === null)
                                            ...
                                            @elseif($permohonan->sebenar_mula_kerja == null )
                                            <td>
                                                <span class="badge badge-pill badge-primary"> Semakan Kakitangan</span><br><br>
                                                ...
                                                <td>
                                                 <span class="badge badge-pill badge-success">Lulus Pengesahan </span><br><br>
                                                    ...
                                                    @elseif($permohonan->lulus_selepas === 1)
                                                            ...
                                                            <span class="badge badge-pill badge-success">Lulus Pengesahan </span>
                                                        </td>
                                                        <td>
                                                            --
                                                        </td>
