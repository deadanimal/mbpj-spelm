                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select class="form-select form-select-sm col-8" name="jenis_permohonan"
                                            ...
                                            <option value="berkumpulan">Permohonan Berkumpulan / Borang A2</option>
                                        </select>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name ="pegawai_sokong_id" class="form-control">
                                                    <option hidden selected > Pilih pegawai sokong</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name ="pegawai_lulus_id" class="form-control">
                                                    <option hidden selected > Pilih pegawai lulus</option>
                                                    @foreach ($users as $user)
                                                    <option value="{{$user->id}}">
                                                        {{$user->name}} - {{$user->role}} </option>
                                                    @endforeach
