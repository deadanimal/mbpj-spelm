    ...
    <div class="container-fluid mt--12">
        ...
        <div class="row ">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header border-0 bg-default">
                        <h3 class="mb-0 text-white">Permohonan Kerja Lebih Masa ( Borang Permohonan A1 dan A2)</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive py-4">
                            ...
                            <table id="permohonankakitangan"
                                ...
                                <tbody class="list">
                                    @foreach ($permohonans as $permohonan)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $permohonan->mohon_mula_kerja }}<br><br>{{ $permohonan->mohon_akhir_kerja }}
                                            </td>
                                            <td>{{ $permohonan->lokasi }} <br><br>{{ $permohonan->tujuan }}</td>
                                            <td>
                                                @foreach ($pengguna as $user)
                                                    @if ($permohonan->pegawai_sokong_id == $user->id)
                                                        {{ $user->name }}
                                            ...
                                            <td>
                                                ...
                                                @if ($permohonan->sokong_sebelum === 1)
                                                    <span class="badge badge-pill badge-success">Lulus
                                                        PG1</span><br><br>
                                                @endif
                                                @if ($permohonan->sokong_sebelum === 0 && $permohonan->jenis_permohonan == 'individu')
                                                    <span class="badge badge-pill badge-danger">Ditolak
                                                        PG1</span><br><br>
                                                    {{ $permohonan->sokong_sebelum_sebab }}
                                                @endif
                                                @if ($permohonan->sokong_sebelum === null && $permohonan->jenis_permohonan == 'berkumpulan')
                                                    <span class="badge badge-pill badge-primary">Dalam Semakan</span>
                                                @endif
                                                @if ($permohonan->lulus_sebelum === null)
