...
<script type="text/javascript">
    ...
    $("#dynamic-ar").click(function () {
        ...
        $("#dynamicAddRemove").append(
            '<tr><td><select name="user_id[]"  placeholder="user_id" class="form-control">@foreach ($kakitangan as $user) <option value="{{$user->id}}"> {{$user->name}} - {{$user->role}} </option> @endforeach  </select></td><td><button type="button" class="btn btn-danger float-right btn-sm remove-input-field">Tolak Kakitangan</button></td></tr>'
        );
    });
