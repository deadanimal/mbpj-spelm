...
<head>
    ...
    <title>404 Error Page with a redirect button - Bootdey.com</title>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="card shadow-lg border-0 rounded-lg mt-5 mx-auto" style="width: 30rem">
                ...
                <span class="card-subtitle mb-2 text-muted text-center">
                    No Pekerja Tiada Dalam <br />
                    Capaian Data Kami
                </span>

                <div class="card-body mx-auto">
                    <a type="button" href="/permohonans" class="btn btn-sm btn-info text-white">
                        Kembali
                    </a>
                </div>
            </div>
