                                ...
                                <div class="col-6">
                                    <div class="form-row align-items-end">
                                        <div class="col-sm-5">
                                            ...
                                            <input id="min" class="form-control form-control-sm" value="DD-MM-YYYY"
                                                autocomplete="off">
                                        </div>
                                        <div class="col-sm-5">
                                            <label class="col-form-label col-form-label-sm" for="max">To</label>
                                            <input id="max" class="form-control form-control-sm" value="DD-MM-YYYY"
                                                autocomplete="off">
                                        </div>
                                        <div class="col-sm-2 text-center">
                                            <button class="btn btn-sm btn-primary" id="btnGo"
