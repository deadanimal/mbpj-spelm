                    ...
                    <div class="card">
                        ...
                        <div class="col-lg-12">
                            <button type="button" class="btn btn-primary btn-sm float-right mb-4" data-toggle="modal"
                                data-target="#simpanfaq">
                                Simpan
                            </button>
                        </div>
                        <!-- Modal -->
                        <div class="modal fade" id="simpanfaq" tabindex="-1" role="dialog"
                            aria-labelledby="simpanfaqLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header bg-primary">
                                        <h5 class="text-white modal-title" id="simpanfaqLabel">Kemaskini Soalan Lazim
                                            (FAQ)</h5>
